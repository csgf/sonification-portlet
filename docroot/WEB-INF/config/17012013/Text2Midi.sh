...
mv $INPUT_FILE message2.txt

echo;echo "- Starting the sonification at ";date
if [ ! -z $JAVA_HOME ] ; then
	echo $JAVA_HOME/bin/java Text2Midi
	$JAVA_HOME/bin/java Text2Midi
else
	echo /usr/java/latest/bin/java Text2Midi
        /usr/java/latest/bin/java Text2Midi
fi
...
#
# README - Sonification
# Sonification Algorithm - ASCII2Midi
#
